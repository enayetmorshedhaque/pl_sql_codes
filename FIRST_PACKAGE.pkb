...
IS
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('=============================');
        DBMS_OUTPUT.PUT_LINE(CHR(10) || 'ENTER YOUR CHOICE: ' || SELECT_CHOICE);
    ...
    RETURN VARCHAR2
    IS
        SUCCESS_MESSAGE VARCHAR2(100) := 'ROW UPDATED SUCCESSFULLY';
    BEGIN
        UPDATE CUSTOMERS
        SET NAME = 'WATSON'
    ...
    RETURN VARCHAR2
    IS
        SUCCESS_MESSAGE VARCHAR2(100) := 'ROW DELETED SUCCESSFULLY';
    BEGIN
